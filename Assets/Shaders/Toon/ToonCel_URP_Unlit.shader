Shader "Custom/ToonCel_BuiltIn"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Use the existing appdata struct for the shadow caster to avoid redefinition
            struct v2f_shadow
            {
                V2F_SHADOW_CASTER;
            };

            // Minimal vertex input for the shadow caster. Use a unique name to avoid redefinition
